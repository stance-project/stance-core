...
class BIP66Test(StancecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # stancecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and stancecoind produces more specific reject
            # reasons.
