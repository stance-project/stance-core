...
# TestP2PConn: A peer we use to send messages to stancecoind, and store responses.
...
class CompactBlocksTest(StancecoinTestFramework):
    ...
    # This test actually causes stancecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that stancecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for stancecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # stancecoind will not send blocktxn responses for blocks whose height is
