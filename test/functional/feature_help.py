...
"""Verify that starting stancecoin with -h works as expected."""

from test_framework.test_framework import StancecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(StancecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start stancecoin with -h for help text")
        ...
        self.log.info("Start stancecoin with -version for version information")
        ...
        self.log.info("Start stancecoind with -fakearg to make sure it does not start")
