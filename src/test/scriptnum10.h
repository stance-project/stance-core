...
#ifndef STANCECOIN_TEST_SCRIPTNUM10_H
#define STANCECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Stancecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // STANCECOIN_TEST_BIGNUM_H
