...
{
    BOOST_CHECK(TestSplitHost("www.stancecoincore.org", "www.stancecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.stancecoincore.org]", "www.stancecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.stancecoincore.org:80", "www.stancecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.stancecoincore.org]:80", "www.stancecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9301", "127.0.0.1", 9301));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9301", "127.0.0.1", 9301));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9301", "::ffff:127.0.0.1", 9301));
    BOOST_CHECK(TestSplitHost("[::]:9301", "::", 9301));
    BOOST_CHECK(TestSplitHost("::9301", "::9301", -1));
    BOOST_CHECK(TestSplitHost(":9301", "", 9301));
    BOOST_CHECK(TestSplitHost("[]:9301", "", 9301));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9301", "127.0.0.1:9301"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9301", "[::]:9301"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
