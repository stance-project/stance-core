...
#ifndef STANCECOIN_WALLET_WALLET_H
#define STANCECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this stancecoin node, and set to 0 for transactions that were created
...
#endif // STANCECOIN_WALLET_WALLET_H
