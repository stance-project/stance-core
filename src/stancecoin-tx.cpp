...
static void SetupStancecoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " stancecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  stancecoin-tx [options] <hex-tx> [commands]  Update hex-encoded stancecoin transaction\n" +
            "or:     stancecoin-tx [options] -create [commands]   Create hex-encoded stancecoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stancecoin transaction
