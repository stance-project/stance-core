...
#ifndef STANCECOIN_QT_STANCECOINUNITS_H
#define STANCECOIN_QT_STANCECOINUNITS_H
...
/** Stancecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StancecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StancecoinUnits(QObject *parent);

    /** Stancecoin units.
      @note Source: https://en.stancecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef StancecoinUnits::Unit StancecoinUnit;

#endif // STANCECOIN_QT_STANCECOINUNITS_H
