    ...
    mapper(0)
{
    ...
    ui->stancecoinAtStartup->setToolTip(ui->stancecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->stancecoinAtStartup->setText(ui->stancecoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openStancecoinConfButton->setToolTip(ui->openStancecoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new StancecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->stancecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openStancecoinConfButton_clicked()
{
