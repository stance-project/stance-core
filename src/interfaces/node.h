...
#ifndef STANCECOIN_INTERFACES_NODE_H
#define STANCECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a stancecoin node (stancecoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // STANCECOIN_INTERFACES_NODE_H
