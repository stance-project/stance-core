Stancecoin Core version 0.9.4 is now available from:

  https://stancecoin.org/bin/0.9.4/
...
this update is incompatible with the Stancecoin system and could lead to consensus
forks.

Stancecoin Core released binaries from https://stancecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~stancecoin/+archive/ubuntu/stancecoin
- A third-party or self-compiled Stancecoin Core

upgrade to Stancecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
