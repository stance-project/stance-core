Stancecoin Core version 0.10.4 is now available from:

  <https://stancecoin.org/bin/stancecoin-core-0.10.4/>
...
- #6953 `43c2789` Split stancecoin-tx into its own package
- #6953 `dfe0d4d` Include stancecoin-tx binary on Debian/Ubuntu
