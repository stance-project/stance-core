Stancecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/stancecoin/files/Stancecoin/stancecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Stancecoin
...
New/changed settings (command-line or stancecoin.conf file)
--------------------------------------------------------
