Stancecoin Core version 0.16.1 is now available from:

  <https://stancecoincore.org/bin/stancecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting stancecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure stancecoind processes are cleaned up when tests end (sdaftuar)
