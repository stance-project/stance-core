Stancecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/stancecoin/files/Stancecoin/stancecoin-0.5.4/
...
http://gitorious.org/stancecoin/stancecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Stancecoin-Qt notifications under Growl 1.3.
Increase required age of Stancecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxStancecoin properly when installing Stancecoin-Qt over it. (Windows)
