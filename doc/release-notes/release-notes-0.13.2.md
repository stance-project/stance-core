Stancecoin Core version 0.13.2 is now available from:

  <https://stancecoin.org/bin/stancecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update stancecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow stancecoin-tx to create v2 transactions (btcdrak)
