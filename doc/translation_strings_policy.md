...
This document provides guidelines for internationalization of the Stancecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `stancecoin_en.ts` remains unchanged.
